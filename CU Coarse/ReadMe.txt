This package will install Python 3.4.1 for Mac OS X
...
Shell Profile" command found in the /Applications/Python 3.4
folder.  You may need to start a new terminal window for the
changes to take effect.

Python.org Python 3.4 and 2.7.x versions can both be installed and
...
"Python 3.4" subfolder of the system Applications folder,
...
Installation requires approximately 91 MB of disk space,
